            ...
            <Page size="A4" style={styles.page} wrap>
                ...
                {data.exteriorPhoto && (
                    <View style={{ marginBottom: 20, alignItems: 'center' }} wrap={false}>
                        ...
                        <Text style={[styles.imageDescription, { textAlign: 'center', marginTop: 5 }]}>Au├ƒenansicht / ├£bersicht</Text>
                    </View>
                )}
                ...
                <View style={styles.footer} fixed>
                    <View style={{ width: '100%', alignItems: 'center' }}>
                        <Text style={styles.footerText}>Q-Service AG, Kriesbachstrasse 30, 8600 D├╝bendorf, www.q-service.ch, info@q-service.ch Tel. 043 819 14 18</Text>
                    </View>
