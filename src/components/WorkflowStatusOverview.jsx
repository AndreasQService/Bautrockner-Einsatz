...
function Popover({rid,step,sd,onSave,onClose,rect}) {
  ...
  const st={position:"fixed",zIndex:9999,background:"#1A2332",border:"1px solid rgba(255,255,255,0.14)",borderRadius:14,padding:"1rem",width:240,boxShadow:"0 24px 56px rgba(0,0,0,0.55)",animation:"wfFade 0.12s ease"}
...
export default function WorkflowStatusOverview({reports,onSelectReport,currentUser,users=[]}) {
  ...
  return (
    <div style={{marginBottom:"1.5rem",background:"var(--color-surface,#0F172A)",borderRadius:12,border:"1px solid var(--color-border,rgba(255,255,255,0.08))",overflow:"hidden"}}>
