...
import ProjectTaskAssignmentInfo from '../../components/ProjectTaskAssignmentInfo.jsx';
  ...
  return (
    <>
      ...
      >
        ...
        <ProjectListMetadata row={row} col={col} PAL={PAL} />
        ...
        <div
          ...
          onClick={e => e.stopPropagation()}
        >
          <ProjectTaskAssignmentInfo row={row} />
