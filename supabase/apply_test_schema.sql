-- ======================================================================
-- DAUERHAFTER SCHEMA-NEUAUFBAU FÜR SUPABASE-TESTPROJEKT (QTool-Test)
...
-- ----------------------------------------------------------------------
-- 5. PRE-COMMIT POST-CHECK INNERHALB DER TRANSAKTION
-- ----------------------------------------------------------------------
DO $$
DECLARE
...
-- ----------------------------------------------------------------------
-- COMMIT DAUERHAFTER SCHEMA-NEUAUFBAU
-- ----------------------------------------------------------------------
COMMIT;

-- ----------------------------------------------------------------------
-- 6. POST-COMMIT VERIFIKATION (EXAKTE SCHLÜSSEL)
-- ----------------------------------------------------------------------
